  ...
  return (
    <div className="min-h-screen py-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://b11-a10-papiya.netlify.app/about" />
      </Helmet>
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <p className="text-lg text-justify leading-relaxed">
          Welcome to{" "}
          <span className="text-primary font-semibold">HobbyHub</span> – your
          ultimate destination for connecting with like-minded individuals and
          discovering amazing interest-based communities. Whether you're
          passionate about books, gardening, coding, photography, or anything
          else, HobbyHub provides a friendly platform to join, create, and
          manage hobby groups.
        </p>
